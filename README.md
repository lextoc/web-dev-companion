...
<p align="center">
  <a href="https://github.com/lextoc/web-dev-companion/releases/tag/v0.1.0-alpha.10"><img alt="Latest alpha" src="https://img.shields.io/badge/latest-0.1.0--alpha.10-2563EB"></a>
...
- [Download for macOS](https://github.com/lextoc/web-dev-companion/releases/download/v0.1.0-alpha.10/Web-Dev-Companion-Mac-0.1.0-alpha.10.dmg)
- [Download for Windows](https://github.com/lextoc/web-dev-companion/releases/download/v0.1.0-alpha.10/Web-Dev-Companion-Windows-0.1.0-alpha.10-Setup.exe)
