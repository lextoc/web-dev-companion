...
<p align="center">
  <a href="https://github.com/lextoc/web-dev-companion/releases/tag/v0.1.0-alpha.6"><img alt="Latest alpha" src="https://img.shields.io/badge/latest-0.1.0--alpha.6-2563EB"></a>
...
Latest alpha: `0.1.0-alpha.6`

- macOS: signed and notarized alpha pending.
- [Download for Windows](https://github.com/lextoc/web-dev-companion/releases/download/v0.1.0-alpha.6/Web-Dev-Companion-Windows-0.1.0-alpha.6-Setup.exe)
